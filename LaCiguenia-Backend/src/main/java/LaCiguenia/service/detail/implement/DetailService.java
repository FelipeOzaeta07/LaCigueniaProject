    ...
    public ResponseEntity<GenericResponseDTO> createDetail(DetailDTO detailDTO) {
        try {
            ...
            if (!detailExist.isPresent()){
                ...
                Integer amountInventory = inventoryExist.get().getInventoryAmount();
                Integer detailAmount = detailDTO.getDetailAmount();
                Integer total = amountInventory - detailAmount;
                inventoryExist.get().setInventoryAmount(total);
